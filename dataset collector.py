...
face_name=str(input('enter persons name ====> '))
...
print("one....")
time.sleep(1)
print(""" sssssss   mmm       mmm   iiiiiiiiii  lll       eeeeeeeee
          ss        mm  m   m  mm       ii      lll       eee
          sssssss   mm   m m   mm       ii      lll       eeeeeeeee
               ss   mm    m    mm       ii      lll       eee
          sssssss   mm         mm   iiiiiiiiii  lllllllll eeeeeeeee """
